...
export function loadAgentConfig(agentId: string): AgentConfig {
  ...
  return { name, description, botTokenEnv, botToken, model, mcpServers, elevenlabsVoiceId, elevenlabsModelId, elevenlabsSpeechTags, 'voice-agent': voiceAgent, obsidian };
}
